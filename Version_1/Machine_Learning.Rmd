...
set.seed(100)
model_mars2 = train(Purchase ~ ., data=trainData, 
                    method='earth', 
                    tuneLength = 5, 
                    metric='ROC', 
...
set.seed(100)
models <- caretList(Purchase ~ ., data=trainData, 
...
#save.image("~/Google Drive/EBAC_G/Predictive Analytics/CA/data/Machine_Learning.RData")
