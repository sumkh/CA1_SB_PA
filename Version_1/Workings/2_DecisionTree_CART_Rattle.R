...
write.csv(cbind(sdata, crs$pr), file="/Users/briansum/Documents/OneDrive/EBAC_M/GitHub/CA1_SB_PA/R_Rattle/loans_df_test_score_idents_rpart.csv", row.names=FALSE)
